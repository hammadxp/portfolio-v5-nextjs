  ...
  miniTools: [
    {
      ...
      tag: "Python CLI Tool",
      description: "Unify is a CLI app that allows users to save their Spotify library locally, keep it in sync, and many other features.",
